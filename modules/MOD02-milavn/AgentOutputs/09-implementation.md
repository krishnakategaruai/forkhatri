...
Working application: **web** `modules/MOD02-milavn/milavn-web` (Next.js 16, port **3001**) · **API** `modules/MOD02-milavn/milavn-service` (FastAPI, port **8001**) · **DB** `forkhatridb` on `localhost:5433`, schemas `milavn_*` (migrations `07a-db-implementation/migrations/001–014`).
