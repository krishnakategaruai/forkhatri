-- =============================================================================
-- Migration 001 — initial schema. No prior migration; this is the first.
-- Vyapar (MOD01) — Postgres schema DDL. Idempotent (IF NOT EXISTS / DROP-then-
-- CREATE POLICY throughout) — safe to re-run against an already-migrated
-- database. This file is kept byte-identical in content/intent to
-- ../schema.sql (the fast-setup snapshot); if they ever diverge, this file is
-- authoritative. See 07a-db-implementation/README.md.
--
