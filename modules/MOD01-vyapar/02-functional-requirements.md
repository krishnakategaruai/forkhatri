...
| 2026-09-14 | Added a pointer under FR50 to the ForKhatri platform identity contract (`docs/ParentApp/07-tech-reqs.md` TR10–TR16). No requirement text changed. Not re-sealed; awaits the owner's review. | Product-owner instruction, 2026-09-14: one ForKhatri identity and entrance. |
...
> **2026-09-14 pointer:** the platform integration contract this FR consumes (session cookie resolved by Vyapar's Identity Bridge, `vyapar.members` as the member-link table, redirect to the ForKhatri entrance with `return_to`) is docs/ParentApp/07-tech-reqs.md TR10–TR16.
