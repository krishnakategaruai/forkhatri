...
Component package for MangalyService. Traces to: BR07.
Owns the `mangaly_compatibility` schema.

Personality-assessment scaffolding is instrument-agnostic: the instrument itself is genuinely
still open (v1-decisions.md).
