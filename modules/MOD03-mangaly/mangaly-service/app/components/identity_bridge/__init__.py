...
Component package for MangalyService. Traces to: BR-prereq (FR090-FR095, FR101).
Owns the `mangaly_identity` schema.

Thin for authorization; owns the INTERIM credential/session store only (named technical debt,
migrates to a future Common Platform Identity & Trust Service).
