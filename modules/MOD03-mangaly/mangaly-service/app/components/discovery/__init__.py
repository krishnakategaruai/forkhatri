...
Component package for MangalyService. Traces to: BR06.
Owns the `mangaly_discovery` schema.

Owns its own Postgres-FTS read model, synced via domain events — never a live cross-schema query.
