"""Audit Bridge component.

Component package for MangalyService. Traces to: BR15.
Owns no schema (schema-less by design).

Genuinely schema-less by design: forwards every event to the platform Audit Log Store (ADR-011)
